...
public class GetSiftedAppenderFunction<A>
        implements Function<SiftingAppender, Optional<A>> {
    ...
    public static <AT extends Appender<ILoggingEvent>> GetSiftedAppenderFunction<AT> create(String key) {
