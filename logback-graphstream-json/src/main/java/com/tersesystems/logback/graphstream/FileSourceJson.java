        ...
        public boolean next() throws IOException, ParseException {
            if (iterator.hasNext()) {
                ...
                if (event instanceof Node.Add) {
                    ...
                    source.sendEdgeAdded(sourceId, ae.getEdgeId(), ae.getFromNodeId(), ae.getToNodeId(), ae.isDirected());
