...
/**
 * A <a href="https://en.wikipedia.org/wiki/Circular_buffer">circular buffer</a> that contains a bounded queue of elements.
 *
 * This implementation adds an append method which will remove elements from the head of the queue until the appended
 * event is successfully offered.
 *
...
public class RingBuffer<ElementT> implements Queue<ElementT> {
    ...
    /**
     * Appends event to the end of the queue using offer.  If the queue is full, then the head element is removed.
     *
