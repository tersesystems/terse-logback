...
public class AdviceConfig {
    ...
    static final class TraceConfig {
        ...
        private TraceConfig(List<String> classNames,
         ...
         static TraceConfig create(ClassLoader classLoader, String className, List<String> methodNames) throws Exception {
        TypeDescription aClass = createTypeDescription(classLoader, className);

            return new TraceConfig(singletonList(className), is(aClass), methodNames.stream()
