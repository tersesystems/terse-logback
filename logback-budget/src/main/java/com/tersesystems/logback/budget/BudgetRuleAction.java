...
public class BudgetRuleAction extends Action {
    ...
    public void begin(InterpretationContext ic, String localName, Attributes attributes) throws ActionException {
        ...
        if (!(o instanceof BudgetRuleAttachable)) {
            String errMsg = "Could not find a BudgetRuleAttachable at the top of execution stack. Near [" + localName + "] line " + getLineNumber(ic);
            inError = true;
        ...
        try {
            ...
            budgetRule = (BudgetRule) OptionHelper.instantiateByClassName(className, BudgetRule.class, context);
