...
output = [
	...
	'',
	link(shield('Release Notes', 'release', '{{version}}', 'brightgreen'), 'docs/release-notes.md'),
...
[![Release Notes](https://img.shields.io/badge/release-0.13.1-brightgreen.svg)](docs/release-notes.md)
